...
public class SecondaryForLoop2 {
    ...
    private int range;
    private static boolean debugQuitLoop = false;
    private boolean operatingInBatchMode;
    ...
    private void postCompleteOperationSingle() {
        ...
        msg.what = RenderValues.ONE_CALULATION_COMPLETED_BATCH;
    ...
    private void postCompleteOperationBatch(boolean forceSend) {
        ...
        if(currentBatchAmount >= currentBatchAmountRange || forceSend){
            ...
            bundle.putString(RenderValues.MESSAGE_NAME_ID, String.valueOf(currentBatchAmount));
            msg.setData(bundle);
            handler.sendMessage(msg);
